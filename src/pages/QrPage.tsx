...
function qrMatrix(seed: number) {
  ...
  return Array.from({ length: SIZE * SIZE }, (_, index) => {
    ...
    if (row === 6 && col > 7 && col < 14) return col % 2 === 0;
    if (col === 6 && row > 7 && row < 14) return row % 2 === 0;
    return random() > 0.52;
  });
}
